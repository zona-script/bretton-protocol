...
contract GovernorAlpha {
    ...
    string public constant name = "Bretton Governor Alpha";

    /// @notice The number of votes in support of a proposal required in order for a quorum to be reached and for a vote to succeed
    function quorumVotes() public view returns (uint256) { return SafeMath.div(SafeMath.mul(BRET.totalSupply(), 4), 100); } // 4% of Bretton

    /// @notice The number of votes required in order for a voter to become a proposer
    function proposalThreshold() public view returns (uint256) { return SafeMath.div(BRET.totalSupply(), 100); } // 1% of Bretton
    ...
    constructor(address timelock_, address BRET_) public {
        timelock = TimelockInterface(timelock_);
        BRET = BRETInterface(BRET_);
        guardian = msg.sender;
    }
    ...
    function propose(
        ...
        returns (uint256)
    {
        require(BRET.balanceOf(msg.sender) > proposalThreshold(), "GovernorAlpha::propose: proposer votes below proposal threshold");
        ...
        public
    {
        ...
        Proposal storage proposal = proposals[proposalId];
        require(msg.sender == guardian || BRET.balanceOf(proposal.proposer) < proposalThreshold(), "GovernorAlpha::cancel: proposer above threshold");
        ...
        internal
    {
        ...
        uint256 votes = BRET.balanceOf(voter);
